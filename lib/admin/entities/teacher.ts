...
const teacherSchema = z.object({
  ...
  leave_period_start: z.string().optional().or(z.literal("")),
  leave_period_end: z.string().optional().or(z.literal("")),
  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        {
          name: "leave_period_start",
          label: "Leave Period — From",
          type: "date",
          helper: "Optional. Only applies while on study leave.",
        },
        {
          name: "leave_period_end",
          label: "Leave Period — To",
          type: "date",
          helper: "Optional. Leave blank if the return date is open.",
        },
